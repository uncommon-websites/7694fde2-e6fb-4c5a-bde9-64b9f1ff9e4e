    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
      ...
      <div>
        ...
        <ul class="space-y-3 text-sm text-gray-500">
          ...
          <li><a href="/#features" class="hover:text-gray-900">Visual Builder</a></li>
          <li><a href="/#integrations" class="hover:text-gray-900">Integrations</a></li>
          <li><a href="/#templates" class="hover:text-gray-900">Templates</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-3 text-sm text-gray-500">
          <li><a href="/#help" class="hover:text-gray-900">Documentation</a></li>
          <li><a href="/#api" class="hover:text-gray-900">API Reference</a></li>
          <li><a href="/#pricing" class="hover:text-gray-900">Pricing</a></li>
          <li><a href="/#community" class="hover:text-gray-900">Community</a></li>
          <li><a href="/#examples" class="hover:text-gray-900">Examples</a></li>
      ...
      <div>
        ...
        <ul class="space-y-3 text-sm text-gray-500">
          <li><a href="/#notion" class="hover:text-gray-900">vs Notion</a></li>
          <li><a href="/#trainual" class="hover:text-gray-900">vs Trainual</a></li>
          <li><a href="/#zapier" class="hover:text-gray-900">vs Zapier</a></li>
          <li><a href="/#make" class="hover:text-gray-900">vs Make</a></li>
          <li><a href="/#n8n" class="hover:text-gray-900">vs n8n</a></li>
          <li><a href="/#airflow" class="hover:text-gray-900">vs Airflow</a></li>
        </ul>
      </div>
    </div>

    <div class="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
      <p class="text-xs text-gray-400">© 2025 Macadamia. All rights reserved.</p>
